...
<script>
  ...
  sum.addEventListener('click', () => {
    postData('/api_calc', {"operand1": operand1.value, "operand2": operand2.value, "operation": sum.innerText})
  });
  sub.addEventListener('click', () => {
    postData('/api_calc', {"operand1": operand1.value, "operand2": operand2.value, "operation": sub.innerText})
  });
  mul.addEventListener('click', () => {
    postData('/api_calc', {"operand1": operand1.value, "operand2": operand2.value, "operation": mul.innerText})
  });
  div.addEventListener('click', () => {
    postData('/api_calc', {"operand1": operand1.value, "operand2": operand2.value, "operation": div.innerText})
  });
