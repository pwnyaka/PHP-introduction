...
function doFeedbackAction(&$params, $action) {
    ...
    switch ($_GET['message']) {
        case 'OK':
            $params['message'] = "Отзыв добавлен!";
            break;
        case 'edit':
            $params['message'] = "Отзыв изменен!";
            break;
        case 'deleted':
            $params['message'] = "Отзыв удален!";
            break;
        case 'del_error':
            $params['message'] = "Ошибка при удалении отзыва!";
            break;
        case 'add_error':
            $params['message'] = "Заполните пустые поля!";
            break;
        case 'add_name_error':
            $params['message'] = "Введите свое имя!";
            break;
        case 'add_feedback_error':
            $params['message'] = "Введите текст отзыва!";
            break;
    }
}
